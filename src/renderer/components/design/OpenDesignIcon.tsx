...
/** Open Design brand mark (apps/web/public/brand-icon.svg, Apache-2.0) — tinted via currentColor like lucide icons. */
export default function OpenDesignIcon({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 444 444" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
