...
const CAPABILITIES: Record<string, HarnessCapabilities> = {
  claude:   { supportsAsyncInjection: false, supportsMultiTurn: true,  minTurnGapMs: 500, maxCoalesceWindowMs: 3000 },
  codex:    { supportsAsyncInjection: false, supportsMultiTurn: false, minTurnGapMs: 500, maxCoalesceWindowMs: 3000 },
